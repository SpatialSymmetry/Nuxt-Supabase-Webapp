...
<section class="w-full bg-gray-200 pt-20 pb-12 lg:pt-36 lg:pb-24">
  ...
  <div class="max-w-screen-lg mx-auto text-center px-4">
    ...
    <p class="mt-4 mb-8 sm:px-16 xl:px-48 text-gray-600">The ECO-SET (Ecosystem Services in an Open Innovation) platform is mainly based on the ECO-SET literature review form (LRF) which aims to provide structured and coherent information on the references examined with respect to ECO-SETs’ key topics to build a structured and solid literature review.</p>
