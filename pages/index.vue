...
<section class="w-full bg-gray-200 pt-20 pb-12 lg:pt-36 lg:pb-24">
  ...
  <div class="max-w-screen-lg mx-auto text-center px-4">
    <p class="font-extrabold tracking-tight text-gray-900 text-5xl">EcoSET Litrature Review Portal.</p>
    <p class="mt-4 mb-8 sm:px-16 xl:px-48 text-gray-600">The platform is mainly based on the EcoSET literature review form (LRF) which aims to provide structured and coherent information on the references examined with respect to EcoSETs’ key topics to build a structured and solid literature review.</p>
...
<section class="w-full bg-gray-200">
  ...
  <button @click="toggleSearchType()"
    ...
    <span class="font-bold">Search Mode:</span> {{ googleScholar ? 'Google Scholar' : 'Local EcoSET Search' }}
  </button>
  </div>
</section>
    ...
    <div class="flex flex-col lg:flex-row">
      ...
      <div class="lg:w-3/4 mx-auto">
        ...
        <div v-if="showFilters" class="bg-gray-700 text-gray-100 border rounded-lg p-4 mb-4 flex flex-col gap-5">
          ...
          <div>
            <p class="font-bold">Filter by EcoSET Keywords:</p>
            <ais-refinement-list 
          ...
          <div>
            <p class="font-bold">Filter by EcoSET Fields of Investigation:</p>
            <ais-refinement-list 
              attribute="fields"
              operator="and"
              :class-names="{
